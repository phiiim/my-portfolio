...
const { Github, Linkedin, Mail, Download, ExternalLink } = LucideIcons;
  ...
  return (
    <div className="min-h-screen bg-slate-900">
      ...
      <div className="h-screen overflow-y-scroll snap-y snap-mandatory">
        {/* Home Section */}
        <section id="home" className="h-screen w-full flex flex-col justify-center items-center bg-slate-900 text-white snap-start">
          <div className="max-w-4xl px-6">
            <h1 className="text-5xl font-bold mb-4">Hi, I&apos;m Phichayapa Soranaraksopon</h1>
            ...
            >
              <Download size={20} className="text-white" /> {/* Added text-white class */}
        ...
        {/* About Section */}
        <section id="about" className="h-screen w-full flex flex-col justify-center items-center bg-slate-800 text-white snap-start">
          <div className="max-w-4xl px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                ...
                {/* <div className="flex gap-4">
                  <span className="font-semibold min-w-[120px]">Experience:</span>
        ...
        <section id="projects" className="h-screen w-full flex flex-col justify-center items-center bg-slate-900 text-white snap-start">
          <div className="w-full px-6">
            <h2 className="text-4xl font-bold mb-8 max-w-4xl mx-auto">Projects</h2>
            ...
            >
              <div className="flex">
                ...
                {/* Project 3 */}
                <div className="snap-center w-full min-w-full p-4">
                  <div className="bg-slate-800 p-6 rounded-lg max-w-4xl mx-auto mb-8">
                    <h3 className="text-2xl font-semibold mb-4 flex items-center gap-2">
