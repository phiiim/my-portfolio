  ...
  return (
    <div className="min-h-screen bg-slate-900">
      ...
      <div className="h-screen overflow-y-scroll snap-y snap-mandatory">
        ...
        {/* Skills Section */}
        <section id="skills" className="min-h-screen w-full flex flex-col justify-center items-center bg-slate-900 text-white snap-start py-16">
          <div className="max-w-4xl px-6 text-center">
        ...
        {/* Education Section */}
        <section id="education" className="min-h-screen w-full flex flex-col justify-center items-center bg-slate-800 text-white snap-start py-16">
          <div className="max-w-4xl px-6 text-center">
        ...
        {/* Projects Section */}
        <section id="projects" className="min-h-screen w-full flex flex-col justify-center items-center bg-slate-900 text-white snap-start py-16">
        ...
        {/* Contact Section */}
        <section id="contact" className="min-h-screen w-full flex flex-col justify-center items-center bg-slate-800 text-white snap-start py-16">
          <div className="max-w-4xl px-6 text-center">
